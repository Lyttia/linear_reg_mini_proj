...
*"Toxic" seems to be the most significant variable followed by "metro". It seems that the model containing the "pop" and "toxic" variables is significantly better than the model with "metro" as the only predictor. I would replace "pop" with another variable to test.* 
